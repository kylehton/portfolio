            ...
            <ScrollMotionWrapper
                contents={
                    <div id="individual-entry">
                        ...
                        <div className='mt-2 font-light text-lg text-zinc-700 flex flex-col lg:flex-row justify-end'>
                            <a className="ml-4 mb-1" rel='external noopener noreferrer' href={content.video}>[video demo]</a>
                            <a className="ml-4 mb-1" rel='external noopener noreferrer' href={content.deployment}>[live deployment]</a>
                            <a className="ml-4 mb-1" rel='external noopener noreferrer' href={content.github}>[github repo]</a>
                        </div>
                    </div>
                }
            />
